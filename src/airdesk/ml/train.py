...
def train_causal_tcn_v2(
    *,
    ...
    sample_tensor, length_tensor, target_tensor, mask_tensor = _evidence_tensors_from_arrays(
        torch,
        arrays,
    )
    train_indices, validation_indices = _split_indices(
...
def _window_rows(window: TcnWindowSample) -> list[Any]:
...
def _make_causal_tcn_sequence_model(
    *,
    torch: Any,
    nn: Any,
    functional: Any,
