...
The frame-evidence target logic lives in `src/airdesk/ml/tcn_v2_evidence.py`; `src/airdesk/ml/dataset.py` is responsible for generic CSV loading, stream grouping, and manifest/window construction.
