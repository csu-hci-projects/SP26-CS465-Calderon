...
- New public-dataset planning pivot: explore whether IPN Hand, Jester, or a better public dynamic/continuous hand dataset can provide useful atomic motion priors. IPN Hand is the likely first experiment because it is continuous and includes natural non-gesture motion; Jester is larger but more clip-classification shaped. Keep AirDesk recordings as the pass/fail authority. Do not train every combo as its own TCN class; train atomic gesture/boundary evidence and put combo interpretation in a second command-grammar layer over emitted events.
