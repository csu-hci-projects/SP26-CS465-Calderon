...
- next best task: use `airdesk view --device /dev/video0` to position the hand and inspect MediaPipe overlays, then `airdesk tune --device /dev/video0 --width 640 --height 480 --fps 30 --fourcc MJPG --show` for live primitive tuning
