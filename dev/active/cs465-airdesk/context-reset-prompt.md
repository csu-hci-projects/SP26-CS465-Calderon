...
1. Use `diagnose-tcn-v2-events` on the schema-2 outputs to tighten the remaining
   negative-motion false activations and chained repeated fires.
2. Keep old replay data (`sprint4-swipes-001`, `sprint4-chained-003`, and the
...
3. After that gate, collect a targeted continuous V2 training/test slice:
...
4. Keep broad combo collection paused until that V2 slice has event-level replay
   evidence.
